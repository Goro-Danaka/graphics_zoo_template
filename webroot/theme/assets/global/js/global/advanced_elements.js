!function (document, window, $) {
    ...
    function formatState(state) {
        ...
        var $state = $(
            '<span><img src="../../../assets/global/image/' + state.element.value.toLowerCase() + '.png" class="img-flag" /> ' + state.text + '</span>'
        );
        return $state;
    };
    ...
    var countries = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.whitespace,
        queryTokenizer: Bloodhound.tokenizers.whitespace,
//        prefetch: '../../../assets/global/js/global/data/countries.json'
    });
...
//        prefetch: '../../../assets/global/js/global/data/nfl.json'
    });
    ...
    var nbaTeams = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
        queryTokenizer: Bloodhound.tokenizers.whitespace,
//        prefetch: '../../../assets/global/js/global/data/nba.json'
    });

    var nhlTeams = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
        queryTokenizer: Bloodhound.tokenizers.whitespace,
//        prefetch: '../../../assets/global/js/global/data/nhl.json'
    });
