...
<section id="content-wrapper">
    <div class="site-content-title">
        <h2 class="float-xs-left content-title-main">Add Portfolios</h2>
        ...
        <ol class="breadcrumb float-xs-right">
            ...
            <li class="breadcrumb-item active">View Portfolios</li>
        </ol>
    </div>
            ...
            <div class="row">  
                ...
                <div class="element-form">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <?= $this->Form->control('featured_image', ['type' => 'file', 'class' => 'dropify', 'label' => FALSE, 'data-plugin' => 'dropify', 'data-height' => '200']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="element-form">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-md-9 col-xs-12">
                        <?= $this->Form->button('Add Portfolio', ['type' => 'submit', 'class' => 'btn btn-success flat-buttons waves-effect waves-button']) ?>
                    </div>
                </div>
            </div>
        </div>
