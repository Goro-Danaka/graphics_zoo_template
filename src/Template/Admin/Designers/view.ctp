                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="personal-info-box">
                                                        <div class="row">
                                                            ...
                                                            <div class="user-name-profile col-xl-6 col-md-12 col-xs-12">
                                                                <div class="left-name-profile float-xs-left">Manager Assigner :</div>
                                                                <div class="detail-profile float-xs-right"><?= ($designer->manager) ? $designer->manager->first_name . ' ' . $designer->manager->last_name : '' ?></div>
                                                            </div>
