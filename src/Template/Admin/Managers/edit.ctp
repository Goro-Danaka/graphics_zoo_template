<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="site-content-title">
            <h2 class="float-xs-left content-title-main">Edit Manager</h2>
        ...
        <div class="content content-datatable datatable-width">
            ...
            <div class="all-form-section">
                <div class="row">                
                    <?= $this->Form->create($manager, ['type' => 'file', 'style' => 'width:100%;']); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        if ($manager->profile_picture_url):
                                            echo $this->Html->image($manager->profile_picture_url, ['class' => 'img img-responsive img-medium']);
                    ...
                    <div class="element-form">
                        ...
                        <div class="col-xl-9 col-lg-9 col-sm-12 col-md-9 col-xs-12">
                            <?= $this->Form->submit('Edit Manager', ['class' => 'btn btn-success flat-buttons waves-effect waves-button']) ?>
                        </div>
                    </div>
                    <?= $this->Form->end(); ?>
                </div>
