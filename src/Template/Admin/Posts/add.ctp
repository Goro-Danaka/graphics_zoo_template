                ...
                <div class="row">                
                    ...
                    <div class="element-form">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <?= $this->Form->control('post_image', ['type' => 'file', 'class' => 'dropify', 'label' => FALSE, 'data-plugin' => 'dropify', 'data-height' => '200']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="element-form">
                        ...
                        <div class="col-xl-9 col-lg-9 col-sm-12 col-md-9 col-xs-12">
                            <?= $this->Form->button('Add Posts', ['type' => 'submit', 'class' => 'btn btn-success flat-buttons waves-effect waves-button']) ?>
                        </div>
                    </div>
                </div>
            </div>
