    ...
    <div class="register_v2_main">
        <div class="register_v2_contain">
            <div class="register_v2_form text-xs-center">
                ...
                <form action="#" id="form-validation" method="post" novalidate="novalidate">
                    ...
                    <div class="register_v2_text_field">
                        <?= $this->Form->control('city', ['placeholder' => 'Enter City', 'label' => FALSE]); ?>
                        <i class="icon icon_pin"></i>
                    </div>

                    <div class="register_v2_text_field">
                        <?= $this->Form->control('country', ['placeholder' => 'Enter Country', 'label' => FALSE]); ?>
