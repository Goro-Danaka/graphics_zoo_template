<section id="content-wrapper">
    ...
    <div class="site-content-title">
        <h2 class="float-xs-left content-title-main">Add Manager</h2>
    ...
    <div class="content content-datatable datatable-width">
        ...
        <div class="all-form-section">
            <div class="row">                
                <?= $this->Form->create($manager, ['type' => 'file']); ?>
                ...
                <div class="element-form">
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-md-9 col-xs-12">
                        ...
                        <?= $this->Form->submit('Add Manager', ['class' => 'btn btn-success flat-buttons waves-effect waves-button']) ?>
                    </div>
                </div>
                <?= $this->Form->end(); ?>
            </div>
